...
define('IBS_CALENDAR_VERSION', '3.6');
...
class IBS_CALENDAR {
    ...
    static $options_defaults = array(
        ...
        "editable" => false,
        "feeds" => array(
            "feed_1" => array('name' => 'Google Holidays', 'enabled' => false, 'url' => 'en.usa#holiday@group.v.calendar.google.com', 'key' => '', 'text_color' => 'white', 'background_color' => '#5484ed', 'nolink' => false, 'altlink' => ''),
            "feed_2" => array('name' => '', 'enabled' => false, 'url' => '', 'key' => '', 'text_color' => 'white', 'background_color' => '#5484ed', 'nolink' => false, 'altlink' => ''),
            "feed_3" => array('name' => '', 'enabled' => false, 'url' => '', 'key' => '', 'text_color' => 'white', 'background_color' => '#5484ed', 'nolink' => false, 'altlink' => '')),
    ...
    static function field_feeds() {
        for ($feed = 1; $feed <= self::$options['feedCount']; $feed++) {
            ...
            echo "<div class='feed-div'><span>No-link</span><input name='ibs_calendar_options[feeds][$curr_feed][nolink]' value='yes' $checked type='checkbox'/></div>";
